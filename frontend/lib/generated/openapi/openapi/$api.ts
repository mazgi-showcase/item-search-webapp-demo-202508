...
import type { Methods as Methods1 } from './items/_id@string'
import type { Methods as Methods2 } from './items/findByText/_text@string'
import type { Methods as Methods3 } from './status'
